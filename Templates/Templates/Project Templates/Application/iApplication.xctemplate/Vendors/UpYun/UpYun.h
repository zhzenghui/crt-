...
#define DEFAULT_BUCKET @"yuefile"
/**
 *	@brief	默认表单API功能密钥 （必填项），可在init之后修改passcode的值来更改
 */
#define DEFAULT_PASSCODE @"KCEazuX9iz6mDU0mIVOQjqnx6Tw="

/**
 *	@brief	默认当前上传授权的过期时间，单位为“秒” （必填项，较大文件需要较长时间)，可在init之后修改expiresIn的值来更改
 */
//#error 必填项
#define DEFAULT_EXPIRES_IN 60

#define API_DOMAIN @"http://v0.api.upyun.com/"
#define API_YueFile_DOMAIN @"http://yuefile.b0.upaiyun.com/"
